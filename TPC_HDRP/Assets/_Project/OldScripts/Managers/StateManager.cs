...
using ANM.Scriptables.Behaviour.StateActions.Init;

 namespace ANM.Managers
 {
     public class StateManager : MonoBehaviour, ILockable
     {
         ...
         public BaseSpellAction equippedSpellAction;
         ...
         {
             return !isPlayer ? myTransform : null;
         }
     }
 }
